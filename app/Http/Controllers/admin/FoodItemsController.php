...
public function store(){
    ...
    return redirect('/admin/food-items')->with('<b>status', 'Food Item Created Successfully!</b>');
}
...
public function delete($id){
    $item = FoodItem::find($id);
    $item->delete();
    return redirect('/admin/food-items')->with('<b>status', 'Food Item Deleted Successfully!</b>');
}
}
